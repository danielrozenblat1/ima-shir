...
import logo from '../../images/אמא שיר לוגו.png';
...
const NavBarNew = () => {
  ...
  return (
    <nav className={`${styles.navbar} ${isSticky ? styles.sticky : ''}`}>
      ...
      {isMenuOpen && windowWidth <= 850 && (
        <div className={styles.mobileMenu}>
          {menuItems.map((item, index) => (
            ...
            <div classsName={styles.center}><img className={styles.image} src={logo} alt="אמא שיר לוגו"/></div>
        </div>
      )}
      {windowWidth > 850 && (
      ...
      <a href="https://www.instagram.com/ima.shir/" target="_blank" rel="noopener noreferrer"><FaInstagram /></a>
